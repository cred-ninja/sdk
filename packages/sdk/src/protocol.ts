 ...
 *
 * The protocol version advertised by SDK clients and selected by the server.
...
/** Lowest Cred Protocol wire version this SDK will accept. */
export const CRED_PROTOCOL_VERSION_MINIMUM = '0.1.0';

/** Protocol versions this SDK can speak, newest first. */
