...
This folder is the top-level documentation index for the open-source Cred repo.
...
- [`@credninja/server`](../packages/server/README.md)
- [`@credninja/sdk`](../packages/sdk/README.md)
- [`@credninja/mcp`](../packages/mcp/README.md)
...
Internal planning, ADRs, data-model notes, and security review docs live under:

- [Internal docs](./internal/README.md)

Those files are useful for contributors, but they are not the best starting point for operators evaluating Cred or integrating it into an app.
